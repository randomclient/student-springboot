...
function menu(){
    ...
    html = html +'<ul>'
    html = html +'<li><a href="/stumgmt/classform">Class Registration</a></li>';
    html = html +'<li><a href="/stumgmt/searchstudent">Student Search</a></li>';
    html = html +'<li><a href="/stumgmt/addstudent">Student Registration</a></li>';
    html = html +'</ul>';
    html = html +'</li>';
    html = html +'<li id="no-child">';
    html = html +'<a href="/stumgmt/usersearch" style="font-weight:bold;">User Management</a>';
    html = html +'</li>';
    html = html +'</ul>';
    html = html +'</div>';
